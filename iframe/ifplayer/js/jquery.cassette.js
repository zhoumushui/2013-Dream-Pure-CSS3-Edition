...
( function( window, $, undefined ) {
	...
	$.Cassette.defaults 	= {
		...
		songs			: [ 'Chinadream', 'Chinadream', 'Chinadream', 'Chinadream' ],
	...
	$.Cassette.prototype 	= {
		...
		_createControls		: function() {
			...
			this.$cStop		= $( '<li class="vc-control-stop">暂停<span></span></li>' );
			this.$cSwitch	= $( '<li class="vc-control-switch">换面<span></span></li>' );
